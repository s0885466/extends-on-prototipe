...
function getDataFromBD(){
    ...
    return new Promise(function (resolve,reject) {
        ...
        setTimeout(function () {
            ...
            console.log('...');
            Math.random() < 0.7 ? resolve(): reject('не удалость получить данные из БД');
        }, 1000);
...
getDataFromBD().then(function () {
    ...
    return new Promise(function (resolve, reject) {
        setTimeout(function () {
            ...
            console.log('...');
            Math.random() < 0.7 ? resolve(): reject('Ошибка формирования списка пользователей');
        }, 1000)
    });
})
    .then(function () {
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                ...
                console.log('Сервер: запрашиваю список пользователей в БД');
                console.log('...');
                Math.random() < 0.7 ? resolve(users): reject('Ошибка запроса пользователей из БД');
            }, 1000);
        });
    ...
    .then(function (usersList) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                ...
                console.log('...');
                Math.random() < 0.7 ? resolve(): reject('Ошибка трансформации данных для клиента');
            }, 1000);
        });
    })
    .then(function () {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                ...
                console.log('...');
                Math.random() < 0.7 ? resolve(): reject('Ошибка получения данных для клиента');
            }, 1000);
        });
    })
